...
class App extends React.Component {
  componentDidMount() {
    ...
    // test
    this.props.store.setAttributes([{attrName: "res", sensitive: false}, {attrName: "ascc", sensitive: false}, {attrName: "jol", sensitive: true}, {attrName: "fmp", sensitive: true}, {attrName: "emp", sensitive: true}, {attrName: "gen", sensitive: false}, {attrName: "gcs", sensitive: false}, {attrName: "cat", sensitive: false}, {attrName: "fue", sensitive: true}, {attrName: "sch", sensitive: false}, {attrName: "lvb", sensitive: false}])
      .then(() => this.props.store.getGBN());
